...
* STRAYOS.md contains the working documentation of the work done including production and deployment configs along side assumtions made. it should be read before attempting anything significant and update upon making changes
